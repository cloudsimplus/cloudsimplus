...
1. Enables running the simulation synchronously, making it easier to interact with it and collect data inside a loop, as the simulation progresses. This brings freedom in the way you can implement your simulations ([#205](https://github.com/manoelcampos/cloudsim-plus/issues/205)).
