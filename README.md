...
**IMPORTANT**
---
- Developing and maintaining this project takes a huge effort. This way, any kind of [contribution](#contributing). Show your support by giving it a star :star: using the button at the top of the GitHub page. It takes no time, helps promoting the project and keeps it evolving. Thanks in advance :clap:.
...
- If you just came across this project and wants to check it later, star it :star:, you'll wont regret that :wink:, it's a promise :pray:.
---
