...
/**
 * This example migrates one vm when a fault happens.
 * @author raysaoliveira
 */
public class MigrationWhenAFaultHappensExample {
    ...
    private static ArrayList<PowerHost> hostList;
    /**
    ...
    public static void main(String[] args) {
        ...
        MigrationWhenAFaultHappensExample migration =
        ...
        migration.createFaultInjectionForHosts(datacenter0);
