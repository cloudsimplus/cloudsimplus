...
public class UtilizationModelDynamicTest {
    ...
    public void testGetUtilizationWhenOneParamConstructor() {
        ...
        final var instance = createUtilizationModel(usagePercentInc, initUsage);
    ...
    public void testGetUtilizationWhenTwoParamConstructorAndMaxUtilization() {
        ...
        final var instance = createUtilizationModel(usagePercentInc, initUsage);
        checkUtilization(initUsage, usagePercentInc, maxUsagePercent, instance);
    }
    ...
    public void testGetUtilization1() {
        ...
        final var instance = createUtilizationModel(increment, 0, initialTime);
