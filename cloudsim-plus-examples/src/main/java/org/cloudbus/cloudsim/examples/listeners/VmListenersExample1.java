...
public class VmListenersExample1 {
    ...
    private void createAndSubmitVms() {
        ...
        vm0.setOnHostAllocationListener(new EventListener<VmInsideHostEventInfo>() {
            @Override
        ...
        vm0.setOnHostDeallocationListener(new EventListener<VmInsideHostEventInfo>() {
            @Override
            public void update(VmInsideHostEventInfo evt) {
                Log.printFormattedLine(
        ...
        Vm vm1 = createVm(1);
        vm1.setOnVmCreationFailureListener(new EventListener<VmInsideDatacenterEventInfo>() {
            @Override
            public void update(VmInsideDatacenterEventInfo evt) {
                Log.printFormattedLine(
