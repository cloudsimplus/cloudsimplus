...
public final class MigrationExample2 {
    ...
    private Datacenter createDatacenter() {
        ...
        * of Hosts to migrate VMs. */
        PowerVmAllocationPolicyMigrationStaticThreshold fallback =
        ...
        this.allocationPolicy =
            new PowerVmAllocationPolicyMigrationMedianAbsoluteDeviation(
    ...
    public PowerHostUtilizationHistory createHost(int numberOfPes, long mipsByPe) {
            ...
            host
                .setPowerModel(new PowerModelLinear(800, 0.3))
