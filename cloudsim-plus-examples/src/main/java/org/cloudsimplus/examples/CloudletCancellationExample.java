...
/**
 * Shows how to cancel the execution of a given Cloudlet
 * after its executes a given amount of MIPS from its total
 * MIPS length.
 *
 * <p>Realize that you can't use the {@link Cloudlet#setStatus(Cloudlet.Status)}
 * to change to directly change the status of a Cloudlet, such as to cancel it.
 * The method is just public due to a design issue.
