...
# -*- coding: utf-8 -*-
#
# CloudSim Plus documentation build configuration file, created by
...
# ones.
extensions = ['sphinx.ext.coverage', 'javasphinx']
...
man_pages = [
    (master_doc, 'cloudsimplus', 'CloudSim Plus Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'CloudSimPlus', 'CloudSim Plus Documentation',
     author, 'CloudSimPlus', 'One line description of project.',
     'Miscellaneous'),
]
