...
Each Datacenter must have its own instance of a
    . The most basic implementation is provided by the class \ :java:ref:`org.cloudbus.cloudsim.allocationpolicies.VmAllocationPolicySimple`\ . Only classes that implement the \ :java:ref:`org.cloudbus.cloudsim.allocationpolicies.power.PowerVmAllocationPolicyMigration`\  interface are able to perform VM migration.
