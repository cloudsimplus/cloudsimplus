...
Provides \ :java:ref:`org.cloudbus.cloudsim.selectionpolicies.VmSelectionPolicy`\  implementations that define policies to be used by a \ :java:ref:`org.cloudbus.cloudsim.hosts.Host`\  to select a \ :java:ref:`org.cloudbus.cloudsim.vms.Vm`\  to migrate from a list of VMs.
