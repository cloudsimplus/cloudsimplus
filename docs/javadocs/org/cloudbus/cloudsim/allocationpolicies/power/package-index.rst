...
Provides power-aware \ :java:ref:`org.cloudbus.cloudsim.allocationpolicies.VmAllocationPolicy`\  implementations. For more general information, see the package \ :java:ref:`org.cloudbus.cloudsim.allocationpolicies`\  at the upper level.
