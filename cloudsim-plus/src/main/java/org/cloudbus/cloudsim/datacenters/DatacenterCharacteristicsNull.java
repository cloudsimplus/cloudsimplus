...
final class DatacenterCharacteristicsNull implements DatacenterCharacteristics {
    ...
    @Override
    public DatacenterCharacteristics setCostPerSecond(double costPerSecond) {
        return DatacenterCharacteristics.NULL;
    }
    ...
    @Override
    public DatacenterCharacteristics setArchitecture(String architecture) {
        return DatacenterCharacteristics.NULL;
    }
    ...
    @Override
    public DatacenterCharacteristics setCostPerBw(double costPerBw) {
        return DatacenterCharacteristics.NULL;
    }

    @Override
    public DatacenterCharacteristics setCostPerMem(double costPerMem) {
        return DatacenterCharacteristics.NULL;
    }

    @Override
    public DatacenterCharacteristics setCostPerStorage(double costPerStorage) {
        return DatacenterCharacteristics.NULL;
    }
