...
public class File {
     ...
     * related to the operation of adding, deleting or getting the file on a sws's storage.
     *
    ...
    /**
     * Sets the sws that will store the file.
     ...
     *
     * @param datacenter the sws that will store the file
     * @return
     */
    ...
    /**
     * Gets the sws that stores the file.
     * @return
     */
