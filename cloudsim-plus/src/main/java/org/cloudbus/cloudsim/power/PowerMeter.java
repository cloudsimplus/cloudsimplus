...
public class PowerMeter extends CloudSimEntity {
    ...
    public PowerMeasurement getPowerMeasurementsSum() {
        return powerMeasurements.stream().reduce(PowerMeasurement::add).orElse(new PowerMeasurement());
    }
