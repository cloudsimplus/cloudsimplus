...
import static org.cloudbus.cloudsim.schedulers.cloudlet.CloudletSchedulerSpaceSharedTestUtil.newSchedulerWithRunningCloudlets;
...
public class CloudletSchedulerSpaceSharedTest {
    ...
    public void testGetTotalUtilizationOfCpuWhenMoreCloudletsThanPes() {
        ...
        final var instance = newSchedulerWithSingleCoreRunningCloudlets(mips, numberOfPes, numberOfCloudlets);
    ...
    public void testGetTotalUtilizationOfCpuWhenDualPesCloudlets1() {
        ...
        final var instance = newSchedulerWithRunningCloudlets(mips, numberOfVmPes, numberOfCloudlets, numberOfCloudletPes);
        final double expected = 1;
        assertEquals(expected, instance.getRequestedCpuPercent(0));
    }
