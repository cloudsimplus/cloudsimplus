...
/**
 * Implements the network layer in CloudSim. It reads a file in the
 ...
 *
 * @todo The class only have static methods, that indicates it doesn't have to
 * be instantiated. In fact, it doesn't appear it is being instantiated
 * anywhere. A private default constructor would be created to avoid
 * instantiation.
 */
public class NetworkTopology {
    ...
    /**
     * Creates the network topology if the file exists and can be successfully
     * parsed. File is written in the BRITE printFormatted and contains
