 ...
 * or Bandwidth) with features to manage resource capacity and allocation.
 * 
...
public interface ResourceManageable <T extends Number> extends Resource<T> {
 ...
 ResourceManageable&lt;Double&gt; objects.
     */
    public static final ResourceManageable NULL_DOUBLE = new ResourceManageable<Double>(){
 ...
 ResourceManageable&lt;Integer&gt; objects.
     */
    public static final ResourceManageable NULL_INT = new ResourceManageable<Integer>(){
 ...
 ResourceManageable&lt;Long&gt; objects.
     */
    public static final ResourceManageable NULL_LONG = new ResourceManageable<Long>(){
