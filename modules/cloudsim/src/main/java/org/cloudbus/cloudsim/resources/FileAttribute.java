...
/**
 * Stores related information regarding to a {@link org.cloudbus.cloudsim.resources.File} entity.
 * 
 * @author Uros Cibej
...
public class FileAttribute {
    ...
    public boolean copyValue(FileAttribute destinationAttr) {
            ...
            destinationAttr.setResourceID(resourceId);
     ...
     * 
     * @return <tt>true</tt> if it is a master copy or <tt>false</tt> if it is a replica
     */
