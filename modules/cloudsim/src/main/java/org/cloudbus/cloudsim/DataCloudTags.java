 ...
 */
public interface DataCloudTags {
     ...
     */
    int PKT_SIZE = DEFAULT_MTU * 100;  // in bytes

    /**
     * The default storage size (10 GB in byte).
     */
    int DEFAULT_STORAGE_SIZE = 10000000;

    /**
     * Registers a Replica Catalogue (RC) entity to a Data GIS.
     */
    int REGISTER_REPLICA_CTLG = BASE + 1;
     ...
     * Data GIS.
     */
    int INQUIRY_LOCAL_RC_LIST = BASE + 2;
     ...
     */
    int FILE_ADD_MASTER_RESULT = RM_BASE + 11;
     ...
     */
    int FILE_ADD_REPLICA = RM_BASE + 12;
     ...
     */
    int FILE_DELETE_MASTER = RM_BASE + 30;
     ...
     */
    int FILE_DELETE_MASTER_RESULT = RM_BASE + 31;
     ...
     */
    int FILE_DELETE_REPLICA = RM_BASE + 32;
     ...
     */
    int CTLG_GET_REPLICA = CTLG_BASE + 1;
     ...
     */
    int CTLG_REPLICA_DELIVERY = CTLG_BASE + 2;
     ...
     */
    int CTLG_GET_REPLICA_LIST = CTLG_BASE + 3;
     ...
     */
    int CTLG_REPLICA_LIST_DELIVERY = CTLG_BASE + 4;
     ...
     */
    int CTLG_GET_FILE_ATTR = CTLG_BASE + 5;

    /**
     * Sends the result for a file attribute back to sender.
     * <p>
     * The format of the reply is {FileAttribute fileAttr}</p>
     * NOTE: The fileAttr could be <tt>null</tt> if not found.
     */
    int CTLG_FILE_ATTR_DELIVERY = CTLG_BASE + 6;
     ...
     */
    int CTLG_DELETE_MASTER = CTLG_BASE + 20;
     ...
     */
    int CTLG_DELETE_MASTER_REPLICAS_EXIST = CTLG_BASE + 25;
     ...
     */
    int CTLG_ADD_REPLICA = CTLG_BASE + 30;
     ...
     * means the error/success message
     */
    int CTLG_ADD_REPLICA_RESULT = CTLG_BASE + 31;

    /**
     * Denotes that replica file addition is successful.
     */
    int CTLG_ADD_REPLICA_SUCCESSFUL = CTLG_BASE + 32;

    /**
     * Denotes that replica file addition is failed due to an unknown error.
     */
    int CTLG_ADD_REPLICA_ERROR = CTLG_BASE + 33;

    /**
     * Denotes that replica file addition is failed because the given file name
     * does not exist in the catalogue.
     */
    int CTLG_ADD_REPLICA_ERROR_DOESNT_EXIST = CTLG_BASE + 34;

    /**
     * Denotes that replica file addition is failed due to the catalogue is
     * full.
     */
    int CTLG_ADD_REPLICA_ERROR_FULL = CTLG_BASE + 35;
     ...
     */
    int CTLG_DELETE_REPLICA = CTLG_BASE + 40;
     ...
     */
    int CTLG_MODIFY_MASTER = CTLG_BASE + 50;
