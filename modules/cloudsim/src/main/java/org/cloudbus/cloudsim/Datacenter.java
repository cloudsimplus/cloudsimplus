...
public class Datacenter extends SimEntity {
    ...
    /**
     * Gets the status of a cloudlet with a given id, owned by a given
     * user and running inside a given VM
     * @param vmId
     * @param userId
     * @param cloudletId
    ...
    /**
     * Gets the scheduling delay to process each event received by the datacenter .
     * 
