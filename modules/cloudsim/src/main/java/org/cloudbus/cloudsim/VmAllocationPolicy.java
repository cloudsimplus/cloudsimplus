...
/**
 * VmAllocationPolicy is an abstract class that represents the policy 
 * used by {@link Datacenter Datacenters} to choose a {@link Host} to allocate a given {@link Vm} into.
